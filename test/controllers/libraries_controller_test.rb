...
class LibrariesControllerTest < ActionController::TestCase
  ...
  test "should create library" do
    assert_difference('Library.count') do
      post :create, library: { description: @library.description, purchased_on: @library.purchased_on, red_id: @library.red_id, user_id: @library.user_id }
    end
  ...
  test "should update library" do
    patch :update, id: @library, library: { description: @library.description, purchased_on: @library.purchased_on, red_id: @library.red_id, user_id: @library.user_id }
    assert_redirected_to library_path(assigns(:library))
  end
